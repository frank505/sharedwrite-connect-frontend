...
const ForgotPassword = () => {
  ...
  return (
    <div
      ...
      id="containerForgotPassword"
      data-testid="forgot-password-root"
    >
      <CContainer>
              ...
              <CCard className="p-12">
                <CCardBody>
                  <CForm
                    ...
                    data-testid="form-forgot-password-container"
                  >
                    ...
                    <CInputGroup className="mb-3">
                      ...
                      <div
                        ...
                        data-testid="forgot-password-email-validation-response"
                      >
