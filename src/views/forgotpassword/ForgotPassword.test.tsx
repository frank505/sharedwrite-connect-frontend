...
const setup = async () => {
  ...
  const forgotPasswordEmailValidationResponse = await findByTestId(
    'forgot-password-email-validation-response',
  )
...
describe('Login component', () => {
  ...
  it('submits form and login failed', async () => {
    const { forgotPasswordEmail, formForgotPasswordContainer, responseForgotPasswordDiv } =
      await setup()
