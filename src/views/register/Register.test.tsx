  ...
  afterEach(() => {
   ...
   afterEach(()=>{;
    ...
    it('validates input on form change', async()=>
    {
      ...
      const {RegisterEmail,RegisterEmailValidationResponse,
        RegisterPassword,RegisterPasswordValidationResponse } = await setup();
...
it('submits form and Register failed', async() =>
{
  ...
  const {RegisterEmail,RegisterPassword,formRegisterContainer,responseRegisterDiv } = await setup();
  userEvent.type(RegisterEmail,'akpufranklin2@gmail.com');
